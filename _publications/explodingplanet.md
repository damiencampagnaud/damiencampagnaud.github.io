...
Les éco-délégués du collège Marguerite Duras ont créé à l’aide de mon aide ainsi que de Mme Chouteau et Mme El Hariri, un jeu de société éco-responsable nommé "Exploding Planet" basé sur les 17 objectifs du développement durable.

Le but du jeu est simple mais dévastateur : éviter de piocher la carte « Exploding Planet » et ainsi empêcher la planète d’exploser. Pour cela, tout est permis (ou presque). Vous pouvez jouer des cartes éco-gestes, des cartes solidarité, des cartes D.D. et pleins d’autres cartes en rapport avec les 17 objectifs du développement durable. Au total, nous en avons créé 150 qui vous garantirons des parties à rebondissements !
